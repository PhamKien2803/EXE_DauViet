    ...
    <div className="font-sans">
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-20 py-4 bg-white shadow-md">
        ...
        <ul className="flex space-x-8 text-sm font-medium">
          <li className="cursor-pointer hover:text-orange-500" onClick={() => navigate("/")}>Trang chủ</li>
                    ...
                    <div>
                          ...
                          <li key={item._id} className="flex items-center gap-3 py-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center mt-1">
                                <button className="text-lg font-bold text-orange-500 border rounded-full w-7 h-7" onClick={() => handleDecrease(item._id)}>-</button>
                                <span className="w-6 mx-2 text-center">{item.quantity}</span>
                                <button className="text-lg font-bold text-orange-500 border rounded-full w-7 h-7" onClick={() => handleIncrease(item._id)}>+</button>
                              </div>
                            </div>
                            <div className="text-right">
                              ...
                              <button className="mt-2 text-gray-400 hover:text-red-500" onClick={() => handleRemove(item._id)} title="Xóa">
                      ...
                      <div className="flex pt-3 pb-3 mb-2">
                        ...
                        <label htmlFor="agree" className="text-sm">
                          ...
                          <Link to="/" className="text-blue-500 underline"> điều khoản </Link>
                          và
                          <Link to="/" className="text-blue-500 underline"> điều kiện thanh toán</Link>
                        </label>
                      </div>
          ...
          {loggedIn ? (
            <div className="flex items-center gap-3 ml-2">
              <p className="text-sm font-medium text-gray-700">
                👋 Chào, <span className="font-semibold text-orange-500">{user?.username}</span>
              </p>
              <button
